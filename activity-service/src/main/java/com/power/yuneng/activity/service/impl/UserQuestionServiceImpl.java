...
public class UserQuestionServiceImpl extends AbstractPageService<Integer, IUserQuestionDAO, UserQuestion> implements IUserQuestionService {
    @Autowired
    private IUserQuestionDAO userQuestionDAO;

    @Override
    public IUserQuestionDAO getDao() {
...
//        return userQuestionDAO.findAll();
//    }
//
//    @Override
...
//
//    @Override
//    protected UserQuestionDAO getDao() {
//        return userQuestionDAO;
//    }
//
//    @Override
