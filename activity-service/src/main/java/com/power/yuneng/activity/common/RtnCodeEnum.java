...
import com.power.core.utils.TBCConstants;
...
public enum RtnCodeEnum {
    ...
    ANSWER_EXIST("unknow", "9000001", "问卷已存在"),
    ACTIVITY_NOT_START("unknow", "9000002", "活动未开始"),
    ACTIVITY_END("unknow", "9000003", "活动已结束"),
    ACTIVITY_NOT_EXIST("unknow", "9000004", "活动不存在"),
